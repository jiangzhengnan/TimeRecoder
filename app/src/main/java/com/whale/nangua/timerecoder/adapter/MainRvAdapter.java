...
import com.whale.nangua.timerecoder.utils.MainRvTypeUtil;
...
public class MainRvAdapter extends RecyclerView.Adapter<PictureCarouselViewHolder> implements MainRvTypeUtil {
    ...
    public void onBindViewHolder(PictureCarouselViewHolder holder, int position) {
        if (i == 2) {
            View view = LayoutInflater.from(context).inflate(R.layout.main_home_others, null);

            NGImageloadHelper.displayImage((ImageView) view.findViewById(R.id.one_img1),
                    "https://img3.doubanio.com//mpic//s28351121.jpg");
            NGImageloadHelper.displayImage((ImageView) view.findViewById(R.id.one_img2),
                    "https://img3.doubanio.com//mpic//s28351123.jpg");
            NGImageloadHelper.displayImage((ImageView) view.findViewById(R.id.one_img3),
                    "https://img3.doubanio.com//mpic//s28351125.jpg");
            NGImageloadHelper.displayImage((ImageView) view.findViewById(R.id.one_img4),
                    "https://img3.doubanio.com//mpic//s28351126.jpg");
        }
